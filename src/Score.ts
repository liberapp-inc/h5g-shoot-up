...
class Score extends GameObject{
    ...
    constructor() {
        ...
        Score.I = this;
        this.point = 0;
        this.text = Util.newTextField("SCORE : 0", Util.width / 22, 0xf0c000, 0.5, 0.0, true);
        ...
        this.textBest = Util.newTextField("BEST : " + bestScore, Util.width / 22, 0xf0c000, 0.0, 0.0, true);
